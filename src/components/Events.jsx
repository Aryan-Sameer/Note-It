    ...
    return (
        <section className={`bg-purple-200 w-full px-10 py-7 flex flex-col dark:bg-neutral-700`}>
            <article className="canvas h-full flex flex-col">
                ...
                <div className="main flex gap-8 w-[85%] m-auto flex-grow overflow-y-auto">

                    <section className="calendar w-[40%] relative h-min bg-purple-400 rounded-md dark:text-white dark:bg-neutral-800">
                    ...
                    <section className="events h-full flex-grow overflow-y-auto dark:text-white">
                        <div className="eventList flex flex-col gap-2 h-0">
